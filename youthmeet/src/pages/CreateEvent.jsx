...
export default function CreateEvent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/events/createEvent`, formData, {
        headers: {
    ...
    <div className="max-w-lg mx-auto p-6 bg-white shadow-md rounded-lg mt-24">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end space-x-4">
          <button type="button" onClick={() => navigate("/events")} className="px-4 py-2 bg-gray-300 rounded-md hover:bg-gray-400">
            Cancel
          </button>
